...
/// Attribute characterSet of type xs:string.
   @char*                                characterSet                   1;	///< Required attribute.
...
/// Attribute compression of type xs:string.
   @char*                                compression                    0;	///< Optional attribute.
/// Attribute padChar of type xs:string.
   @char*                                padChar                        0;	///< Optional attribute.
...
/// Attribute decimalMinimum of type xs:string.
   @char*                                decimalMinimum                 0;	///< Optional attribute.
/// Attribute decimalMaximum of type xs:string.
   @char*                                decimalMaximum                 0;	///< Optional attribute.
...
struct tdt__Option
{
/// Size of array of struct tdt__Field* is 1..unbounded
   $int                                  __sizefield                    1;
/// Array struct tdt__Field* of length 1..unbounded
    struct tdt__Field*                   field                          1;
/// Attribute optionKey of type xs:string.
   @char*                                optionKey                      1;	///< Required attribute.
/// Attribute pattern of type xs:string.
   @char*                                pattern                        0;	///< Optional attribute.
/// Attribute grammar of type xs:string.
   @char*                                grammar                        1;	///< Required attribute.
};
...
/// Attribute newFieldName of type xs:string.
   @char*                                newFieldName                   1;	///< Required attribute.
/// Attribute characterSet of type xs:string.
   @char*                                characterSet                   1;	///< Required attribute.
/// Attribute padChar of type xs:string.
   @char*                                padChar                        0;	///< Optional attribute.
...
/// Attribute length of type xs:string.
   @char*                                length                         0;	///< Optional attribute.
/// Attribute function of type xs:string.
   @char*                                function                       1;	///< Required attribute.
/// Attribute tableURL of type xs:string.
   @char*                                tableURL                       0;	///< Optional attribute.
/// Attribute tableParams of type xs:string.
   @char*                                tableParams                    0;	///< Optional attribute.
/// Attribute tableXPath of type xs:string.
   @char*                                tableXPath                     0;	///< Optional attribute.
/// Attribute tableSQL of type xs:string.
   @char*                                tableSQL                       0;	///< Optional attribute.
};

/// "urn:epcglobal:tdt:xsd:1":Level is a complexType.
struct tdt__Level
{
/// Size of array of struct tdt__Option* is 1..unbounded
   $int                                  __sizeoption                   1;
/// Array struct tdt__Option* of length 1..unbounded
    struct tdt__Option*                  option                         1;
/// Size of array of struct tdt__Rule* is 0..unbounded
   $int                                  __sizerule                     0;
/// Array struct tdt__Rule* of length 0..unbounded
    struct tdt__Rule*                    rule                           0;
...
/// Attribute prefixMatch of type xs:string.
   @char*                                prefixMatch                    0;	///< Optional attribute.
/// Attribute requiredParsingParameters of type xs:string.
   @char*                                requiredParsingParameters      0;	///< Optional attribute.
/// Attribute requiredFormattingParameters of type xs:string.
   @char*                                requiredFormattingParameters   0;	///< Optional attribute.
};

/// "urn:epcglobal:tdt:xsd:1":Scheme is a complexType.
struct tdt__Scheme
{
/// Size of array of struct tdt__Level* is 1..unbounded
   $int                                  __sizelevel                    1;
/// Array struct tdt__Level* of length 1..unbounded
    struct tdt__Level*                   level                          1;
/// Attribute name of type xs:string.
   @char*                                name                           1;	///< Required attribute.
/// Attribute optionKey of type xs:string.
   @char*                                optionKey                      1;	///< Required attribute.
...
{
/// Size of array of struct tdt__Scheme* is 1..unbounded
   $int                                  __sizescheme                   1;
/// Array struct tdt__Scheme* of length 1..unbounded
    struct tdt__Scheme*                  scheme                         1;
...
/// Attribute epcTDSVersion of type xs:string.
   @char*                                epcTDSVersion                  1;	///< Required attribute.
};
